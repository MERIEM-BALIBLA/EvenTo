...
<section style="max-width: 32rem; padding: 1.5rem 2rem; margin: 0 auto; background-color: #ffffff; border-radius: 0.75rem; box-shadow: 0 0 1rem rgba(0, 0, 0, 0.1);">
    ...
    <main style="margin-top: 2rem;">
        <h2 style="color: #374151; font-size: 1.5rem; font-weight: 600;">Hello</h2>
        ...
        <a href="{{ route('update_password', $token) }}" style="display: inline-block; padding: 0.75rem 1.5rem; margin-top: 2rem; font-size: 0.875rem; font-weight: 500; text-transform: uppercase; color: #ffffff; background-color: #3b82f6; border-radius: 0.375rem; transition: background-color 0.3s ease-in-out; text-decoration: none;">Reset password</a>
