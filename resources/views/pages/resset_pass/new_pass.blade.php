...
<div
    ...
    <div class="w-full">
        <div class="text-center">
            ...
            <p class="mt-4 text-gray-500">Fill up the form to reset the password</p>
        </div>
        <div class="mt-5">
            <form action="{{route('resetPassword')}}" method="POST">
                ...
                <div class="relative mt-6">
                    <input type="email" name="email" class="peer mt-1 w-full border-b-2 border-gray-300 px-0 py-1 placeholder:text-transparent focus:border-gray-500 focus:outline-none" autocomplete="NA" />
                ...
                <div class="relative mt-6">
                    <input type="password" name="password" class="peer peer mt-1 w-full border-b-2 border-gray-300 px-0 py-1 placeholder:text-transparent focus:border-gray-500 focus:outline-none" />
                ...
                <div class="relative mt-6">
                    <input type="password" name="password_confirm" class="peer peer mt-1 w-full border-b-2 border-gray-300 px-0 py-1 placeholder:text-transparent focus:border-gray-500 focus:outline-none" />
                ...
                <div class="my-6">
                    <button type="submit" class="w-full rounded-md bg-black px-3 py-4 text-white focus:bg-gray-600 focus:outline-none">Save</button>
                </div>
